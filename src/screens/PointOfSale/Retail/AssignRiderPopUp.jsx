...
// import RiderRadioSelect from "../../../components/PosComponents/RiderRadioSelect";
  ...
  return (
    <ModalComponent
      ...
      footer={[
        ...
        <Button onClick={saveRider} disabled={!selectedRiderId}>
          Save
        </Button>,
      ]}
    >
          ...
          {riders?.map((item, index) => (
            <div
              style={{
                ...
                margin: 5,
                background:
                  selectedRiderId === item.RiderId ? PRIMARY_COLOR : "none",
